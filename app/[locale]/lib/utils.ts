...
export const convertServiceType = (service: string) => {
  switch (service) {
    case Service.PERSONAL_PHOTO: return 'Ședință Foto Personalizată';
    case Service.COMMERCIAL_PHOTO: return "Ședință Foto Comercială";
    case Service.MUSIC_VIDEOS: return "Filmare Video Muzical";
    case Service.PODCASTS: return "Filmare Video Podcast"
  }
}