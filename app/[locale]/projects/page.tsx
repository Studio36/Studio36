...
export default function Projects () {
  ...
  return (
    <>
        ...
        <motion.div initial={'initial'} variants={{initial: {opacity: 0}, animate: {opacity: 100}}} animate={isLinkClicked ? 'initial' : 'animate'} transition={{duration: 0.7, ease: easeInOutCubic}} className="layout-grid col-span-8 bg-white">
            <Header setIsLinkClicked={setIsLinkClicked} isLinkClicked={isLinkClicked}/>
            <div className={`grid grid-cols-3 lg:grid-cols-6 lg:col-start-2 col-span-6 transition duration-700 mt-12 lg:mt-24 z-10`}>
