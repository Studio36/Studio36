    ...
    return(
        <>
            ...
            <div className='col-span-2 pr-6 z-10'>
                {photoset.images.length > 0 ? <Image src={photoset.images[0]} width={1000} height={1500} alt={photoset.title} className='rounded-lg w-full'/> : <div className='w-full flex justify-center items-center border border-black border-dashed rounded-lg '>No Photos Added</div>}
                <div className='mt-4'>
