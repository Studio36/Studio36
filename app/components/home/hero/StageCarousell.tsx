...
export default function StageCarousell({ setIsActive, setCursourText, setCursourWidth }: StageCarousellProps) {
  ...
  return (
    <div className='col-start-2 col-span-7 stage-grid mt-24 mb-48 relative'>
        ...
        <div className='col-start-7 col-span-1 h-full relative rounded-l-lg overflow-hidden cursor-pointer' onClick={NextSlide} onMouseEnter={() => {setIsActive(true); setCursourText("URMĂTOREA"); setCursourWidth("7.7rem")}} onMouseLeave={() => {setIsActive(false);setCursourText("VEZI MAI MULTE"); setCursourWidth("9.3rem")}}>
