...
export default function Offer() {
  return (
    <div className='col-start-2 col-span-6 grid grid-cols-6'>
        <p className='col-start-3 mb-12'>[CE ÎȚI OFERIM]</p>
        <p className='col-span-6 text-[3rem] font-hedwig indent-[33.3%] mb-24'>Oferim un mediu elegant și funcțional perfect pentru ședințe foto sau producție video. Cu o estetică pastelată și dotări moderne, unde fiecare detaliu e conceput să inspire și să sprijine.</p>
