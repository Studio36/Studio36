...
export default function Footer() {
  ...
  return (
    <div className='layout-grid col-span-3 lg:col-span-8 mt-[7.75rem] lg:mt-48 min-h-screen relative before:content-[""] before:absolute before:-left-4 before:top-0 before:w-[calc(100%+2rem)] lg:before:w-[calc(100%+1rem)] before:h-full before:bg-black before:dark:bg-white before:-z-10 before:transition-all before:duration-300'>
        <div className="layout-grid absolute top-0 left-0 w-full h-full pointer-events-none">
          ...
          <motion.div className="col-span-3 lg:col-span-8 layout-grid" variants={parentVariants} animate={controls}>
            <div className='mt-[8.6rem] lg:mt-[14.875rem] lg:col-start-3 col-span-3 lg:col-span-5 mb-32'>
                <p className='text-white dark:text-black  mb-2 lg:mb-6 text-sm lg:text-base'>[BRIEFING]</p>
                <motion.p className='text-2xl lg:leading-tight lg:text-[3.5rem] text-white dark:text-black  font-hedwig mb-6 lg:mb-12 w-2/3 lg:w-full' variants={textVariants}>{texts[slide][0]}</motion.p>
